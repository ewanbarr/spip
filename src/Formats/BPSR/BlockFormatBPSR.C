...
#ifdef _DEBUG
  cerr << "spip::BlockFormatBPSR::unpack_ms nsamp=" << nsamp << " nsamp_per_time=" << nsamp_per_time << endl;
  cerr << "spip::BlockFormatBPSR::unpack_ms nchan_per_freq=" << nchan_per_freq << " nblock=" << nblock << end
l;
#endif
